...
public class WebSocketClientHandler extends SimpleChannelInboundHandler<Object> {
    ...
    public void channelActive(ChannelHandlerContext ctx) {
    	   System.out.println("WebSocket channelActive!");
    ...
    public void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (frame instanceof TextWebSocketFrame) {
        	 ...
        	 String receive=textFrame.text();
        	 if(!"pong".equals(receive))
        	 {
        		 service.onReceive(JSON.parse(receive));
        	 }
        } else if (frame instanceof BinaryWebSocketFrame) {
        	BinaryWebSocketFrame binaryFrame=(BinaryWebSocketFrame)frame;
        	 String receive=decodeByteBuff(binaryFrame.content());
        	 if(receive!=null && !"pong".equals(receive))
        	 {
        		 service.onReceive(JSON.parse(receive));
        	 }
